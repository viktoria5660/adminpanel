...
/***/ "./src/app/questions/add-edit-question-dialog/add-edit-question.dialog.component.html":
/*!********************************************************************************************!*\
  !*** ./src/app/questions/add-edit-question-dialog/add-edit-question.dialog.component.html ***!
  \********************************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/questions/add-edit-question-dialog/add-edit-question.dialog.component.scss":
/*!********************************************************************************************!*\
  !*** ./src/app/questions/add-edit-question-dialog/add-edit-question.dialog.component.scss ***!
  \********************************************************************************************/
/*! no static exports found */
...
var URL = 'http://localhost:3000/upload/testupload';
var AddEditQuestionDialogComponent = /** @class */ (function () {
    function AddEditQuestionDialogComponent(dialogRef, data, formBuilder) {
    ...
    AddEditQuestionDialogComponent.prototype.ngOnInit = function () {
        ...
        if (this.data && this.data.question) {
            ...
            this.editMode = false;
            this.question = new _questions_model__WEBPACK_IMPORTED_MODULE_3__["Question"]();
        }
        this.buildForm();
    };
    AddEditQuestionDialogComponent.prototype.buildForm = function () {
        var _this = this;
        var answers = [];
        if (this.question.answers) {
            this.question.answers.forEach(function (answer) {
                answers.push(_this.createAnswer(answer));
            });
        }
        else {
            for (var i = 0; i < 4; i++) {
        ...
        this.form = this.formBuilder.group({
            picture: [this.question.picture, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            template: [this.question.template, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            company: [this.question.company, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            groups: [this.question.groups, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            content: [this.question.content, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            difficulty: [this.question.difficulty, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            answers: this.formBuilder.array(answers)
        });
    };
    AddEditQuestionDialogComponent.prototype.createAnswer = function (answer) {
        return this.formBuilder.group({
            content: [answer ? answer.content : '', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            feedback: [answer ? answer.feedback : '', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            iscorrect: [answer ? answer.iscorrect : false, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required,],
        });
    };
    AddEditQuestionDialogComponent.prototype.onSubmit = function () {
        this.dialogRef.close(this.form.value);
    };
    AddEditQuestionDialogComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-add-edit-question',
            template: __webpack_require__(/*! ./add-edit-question.dialog.component.html */ "./src/app/questions/add-edit-question-dialog/add-edit-question.dialog.component.html"),
            styles: [__webpack_require__(/*! ./add-edit-question.dialog.component.scss */ "./src/app/questions/add-edit-question-dialog/add-edit-question.dialog.component.scss")]
        }),
    ...
    return AddEditQuestionDialogComponent;
}());
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _questions_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./questions.service */ "./src/app/questions/questions.service.ts");
/* harmony import */ var _angular_material__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/material */ "./node_modules/@angular/material/esm5/material.es5.js");
/* harmony import */ var _add_edit_question_dialog_add_edit_question_dialog_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./add-edit-question-dialog/add-edit-question.dialog.component */ "./src/app/questions/add-edit-question-dialog/add-edit-question.dialog.component.ts");
...
var QuestionsComponent = /** @class */ (function () {
    function QuestionsComponent(questionsService, companiesService, dialog) {
        this.questionsService = questionsService;
        this.companiesService = companiesService;
        this.dialog = dialog;
        this.displayedColumns = ['picture', 'difficulty', 'content', 'answers', 'actions'];
    }
    QuestionsComponent.prototype.ngOnInit = function () {
        ...
        this.companiesService.companies$.subscribe(function (companies) {
            if (companies.length > 0) {
                _this.selectedCompany = companies[0];
                _this.getQuestions();
            }
        });
    };
    QuestionsComponent.prototype.getQuestions = function () {
        var _this = this;
        this.questionsService.getQuestionsByCompany(this.selectedCompany.companyName).subscribe(function (questions) {
            _this.dataSource.data = questions;
    ...
    QuestionsComponent.prototype.addQuestion = function () {
        var _this = this;
        var dialogRef = this.dialog.open(_add_edit_question_dialog_add_edit_question_dialog_component__WEBPACK_IMPORTED_MODULE_3__["AddEditQuestionDialogComponent"], {
            maxWidth: '700px'
        });
        dialogRef.afterClosed().subscribe(function (newQuestion) {
            console.log('dialog component closed', newQuestion);
            if (newQuestion) {
                // todo: add question
                _this.questionsService.addQuestion(newQuestion).subscribe(function (response) {
    ...
    QuestionsComponent.prototype.editQuestion = function (question) {
        ...
        dialogRef.afterClosed().subscribe(function (editQuestion) {
            console.log(editQuestion);
            if (editQuestion) {
                // todo: edit question
                _this.questionsService.editQuestion(editQuestion).subscribe(function (response) {
                    // this.message = response.message;
    ...
    QuestionsComponent.prototype.deleteQuestion = function (question) {
        ...
        this.questionsService.deleteQuestion(question).subscribe(function (response) {
            // this.message = response.message;
            console.log('INSIDE delet Q');
        }, function (error) { return console.log(error); });
    };
    QuestionsComponent.prototype.getDifficultyString = function (difficulty) {
        var res;
        switch (difficulty) {
            case 1:
                res = 'Easy';
    ...
    ], QuestionsComponent.prototype, "sort", void 0);
    QuestionsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_questions_service__WEBPACK_IMPORTED_MODULE_1__["QuestionsService"],
            _companies_companies_service__WEBPACK_IMPORTED_MODULE_4__["CompaniesService"],
...
/***/ "./src/app/questions/questions.model.ts":
/*!**********************************************!*\
  !*** ./src/app/questions/questions.model.ts ***!
  \**********************************************/
...
/* harmony import */ var _questions_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./questions.component */ "./src/app/questions/questions.component.ts");
/* harmony import */ var _questions_routing__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./questions.routing */ "./src/app/questions/questions.routing.ts");
/* harmony import */ var _questions_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./questions.service */ "./src/app/questions/questions.service.ts");
/* harmony import */ var _add_edit_question_dialog_add_edit_question_dialog_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./add-edit-question-dialog/add-edit-question.dialog.component */ "./src/app/questions/add-edit-question-dialog/add-edit-question.dialog.component.ts");
    ...
    QuestionsModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                ...
                _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(_questions_routing__WEBPACK_IMPORTED_MODULE_7__["QuestionsRoutes"]),
                ng2_charts_ng2_charts__WEBPACK_IMPORTED_MODULE_4__["ChartsModule"],
                _swimlane_ngx_datatable__WEBPACK_IMPORTED_MODULE_5__["NgxDatatableModule"],
                _angular_flex_layout__WEBPACK_IMPORTED_MODULE_3__["FlexLayoutModule"]
            ],
            declarations: [_questions_component__WEBPACK_IMPORTED_MODULE_6__["QuestionsComponent"], _add_edit_question_dialog_add_edit_question_dialog_component__WEBPACK_IMPORTED_MODULE_9__["AddEditQuestionDialogComponent"], ng2_file_upload__WEBPACK_IMPORTED_MODULE_2__["FileSelectDirective"]],
            providers: [_questions_service__WEBPACK_IMPORTED_MODULE_8__["QuestionsService"]],
            entryComponents: [_add_edit_question_dialog_add_edit_question_dialog_component__WEBPACK_IMPORTED_MODULE_9__["AddEditQuestionDialogComponent"]]
        })
    ], QuestionsModule);
...
/*!************************************************!*\
  !*** ./src/app/questions/questions.routing.ts ***!
  \************************************************/
/*! exports provided: QuestionsRoutes */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "QuestionsRoutes", function() { return QuestionsRoutes; });
/* harmony import */ var _questions_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./questions.component */ "./src/app/questions/questions.component.ts");

var QuestionsRoutes = [{
        path: '',
        component: _questions_component__WEBPACK_IMPORTED_MODULE_0__["QuestionsComponent"]
    }];
...
var QuestionsService = /** @class */ (function () {
    function QuestionsService(apiService) {
        this.apiService = apiService;
        this.questionsSubject = new rxjs_BehaviorSubject__WEBPACK_IMPORTED_MODULE_3__["BehaviorSubject"]([]);
        this.questions$ = this.questionsSubject.asObservable();
        this.loadQuestions();
    }
    QuestionsService.prototype.updateQuestions = function (newQuestions) {
        this.questionsSubject.next(lodash__WEBPACK_IMPORTED_MODULE_2__["cloneDeep"](newQuestions));
    };
    QuestionsService.prototype.getQuestionsValue = function () {
        return lodash__WEBPACK_IMPORTED_MODULE_2__["cloneDeep"](this.questionsSubject.getValue());
    };
    QuestionsService.prototype.loadQuestions = function () {
        // this.apiService.getQuestionsByCompany(companyName: string).subscribe((question:Question[]) => {
        //     this.updateQuestions(question);
        // }, (error) => {
        // });
    };
    QuestionsService.prototype.getQuestionsByCompany = function (companyName) {
        var obs = this.apiService.getQuestionsByCompany(companyName);
        obs.subscribe(function (questions) {
        }, function (error) { return console.log('Questions Service error: ' + error.message); });
        return obs;
    };
    QuestionsService.prototype.deleteQuestion = function (newQuestion) {
        console.log(newQuestion);
        // console.log("INSIDE SET USER SERViCE");
        return this.apiService.deleteQuestion(newQuestion);
    };
    QuestionsService.prototype.addQuestion = function (newQuestion) {
        console.log("INSIDE Q SERVICE ADD Q", newQuestion);
        // console.log("INSIDE SET USER SERViCE");
        return this.apiService.addQuestion(newQuestion);
    };
    QuestionsService.prototype.editQuestion = function (newQuestion) {
